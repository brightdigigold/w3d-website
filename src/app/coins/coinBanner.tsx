        ...
        <div className='flex bg-[#C8E9F2] justify-between mx-auto '>
            ...
            <div className="grid place-items-center">
                <div className="2xl:mt-44">
                    ...
                    <p className="text-black text-center pt-1 poppins-semibold text-xl sm:text-xl md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl">
                        of Gold and Silver Coins
                    </p>
                    <p className="text-black text-center pt-1 text-xl sm:text-sm md:text-md lg:text-xl xl:text-2xl 2xl:text-3xl">
                        at your Doorstep
                    </p>
                </div>
            </div>
