...
const VaultBalance = () => {
    ...
    console.log('error------------>', error, goldVaultBalance);
        ...
        <div className=" text-white mt-4 lg:mt-0 sm:divide-x flex items-center bg-themeLight rounded-md px-3 p-2">
            <div className="flex items-center">
                ...
                <div className="text-white ml-1 pr-4 flex">
                    ...
                    <div className="text-yellow-300 bold">{goldVaultBalance != null ? <p>{goldVaultBalance}</p> : <ButtonLoader loading={loading} buttonText={"fetching..."} />} Gm</div>
                </div>
            </div>
            <div className="flex items-center mt-1 sm:mt-0">
                ...
                <div className="ml-2 flex items-center">
                    ...
                    <div className="text-slate-200 extrabold">{silverVaultBalance != null ? <p>{silverVaultBalance}</p> : <ButtonLoader loading={loading} buttonText={"fetching..."} />} Gm</div>
                </div>
            </div>
        </div>
    )
