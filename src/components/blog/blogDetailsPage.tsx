...
//             setRelatedPosts(shuffledPosts.slice(0, 12)); // Limit to 5-6 posts
//         };
...
//                             <h2 className="text-2xl bold mx-4 text-center sm:mt-6">Related Articles</h2>
//                             <div className="">
...
//                                                 className="rounded"
//                                             />
//                                             <p className="text-md text-white">{relatedPost.title}</p>
//                                         </div>
//                                     </Link>
//                                 ))}
//                             </div>
