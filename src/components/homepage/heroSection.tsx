...
const HeroSection = () => {
  ...
  const redirection = (os: string) => {
    if (os === 'Android') {
      window.location.href = 'https://play.google.com/store/apps/details?id=com.brightdigigold.customer'
    } else if (os === 'iOS') {
      window.location.href = 'https://apps.apple.com/in/app/bright-digi-gold-buy-24k-gold/id1640972173'
    } else {
      window.location.href = 'https://play.google.com/store/apps/details?id=com.brightdigigold.customer'
    }
  }
  ...
  return (
    <>
      {/* <div className="bg-theme mt-24 sm:mt-32">  uncomment this line when poster remove and delete below div */}
      <div> 
        <img className="mt-16 sm:mt-20 mb-9 h-20 sm:h-28 md:h-32 w-full cursor-pointer" onClick={() => redirection(os)} alt='diwali dhamaka' src='/Diwali Dhamaka web banner (1).jpg' />
        {otpModal && <OtpModal />}
