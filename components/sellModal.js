...
import SellPayOutList from "./sellPayoutLists";
...
const SellModal = (props) => {
  ...
  const buyReqApiHandler = async () => {
    const dataToBeDecrypt = {
      purpose: props.isOn ? "SELL_GOLD" : "SELL_SILVER",
      unit: "GRAMS",
      gram: props.gramIn,
      amount: props.rupeeIn,
      order_preview_id: props.transactionId,
      amountWithoutTax: props.rupeeIn,
  ...
  return (
    ...
    >
      <div className="coupons_modal">
        <Modal.Body>
          {isShowUpi ? (
            <SellPayOutList upiList={upiList} upiId={upiId} closeTheModal={closeTheModal} setUpiId={setUpiId} buyReqApiHandler={buyReqApiHandler} />
          ) : (
            <>
                        ...
                        >
                            <div className="countdown-container">
                                ...
                                <div className="text-container">
                                    <div className='low_buy_price'>Current Sell Price: <span style={{ fontWeight: 700 }}> ₹{props.isOn ? props.goldPrice : props.silverPrice}</span></div>
              ...
              <div className="tap_to_continue">
                <button className="button" onClick={showSellUpiList}>NEXT</button>
              </div>
            </>
          )}
        </Modal.Body>
